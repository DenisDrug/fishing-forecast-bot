...
class IntelligentFishingForecaster:
    ...
    def _create_fishing_prompt(self, weather_data: Dict, user_query: str) -> str:
        ...
        ФОРМАТ ОТВЕТА (1 короткий абзац, 1-3 предложения, без списков и таблиц):
        Пример: "Проанализировав погоду, клев ожидается 5/10. Мирная рыба 5/10, хищная 4/10. Оценка учитывает давление, ветер, осадки, фазу луны, сезон и тип ловли (открытая вода или лед)."
